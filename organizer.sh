...
if [ ! -d "$ARCHIVE_DIR" ]; then
    mkdir -p "$ARCHIVE_DIR"
    echo "[INFO]   Archive directory created: '$ARCHIVE_DIR'"
else
    echo "[INFO]  Archive directory '$ARCHIVE_DIR' already exists."
fi
...
echo "[INFO]  Fresh '$SOURCE_FILE' created and ready for the next batch."
...
echo "[INFO]  Operation logged to '$LOG_FILE'."
echo ""
